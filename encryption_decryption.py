...
def viewdata():
    ...
    file_name_label = Label(decryption_window, text="File Name: " , font = 'arial 13')
    file_name_label.place(relx=0.1,rely=0.15, anchor=CENTER)
    
    file_name_entry = Entry(decryption_window, font = 'arial 15')
    file_name_entry.place(relx=0.38,rely=0.15, anchor=CENTER)
    
    btn_open_file = Button(decryption_window, text="Create", font = 'arial 13',command=savedata)
    btn_open_file.place(relx=0.75,rely=0.15, anchor=CENTER)
    
    decryption_text_data = Text(decryption_window, height=20, width=72)
    decryption_text_data.place(relx=0.5,rely=0.55, anchor=CENTER)
